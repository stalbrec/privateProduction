...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/nfs/dust/cms/user/albrechs/production/ntuples/GENSIM/MYPROC/GEN_SIM_MYPROC_MYINT.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:DIGI_RECO_MYPROC_MYINT_step1.root'),
...
process.mixData.input.fileNames = cms.untracked.vstring(['file:/nfs/dust/cms/user/albrechs/production/config/pileupNew.root'])

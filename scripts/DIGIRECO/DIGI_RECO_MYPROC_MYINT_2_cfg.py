...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:DIGI_RECO_MYPROC_MYINT_step1.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:DIGI_RECO_MYPROC_MYINT.root'),

...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/nfs/dust/cms/user/albrechs/production/ntuples/DIGIRECO/MYPROC/DIGI_RECO_MYPROC_MYINT.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:MINIAOD_MYPROC_MYINT.root'),

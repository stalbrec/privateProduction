...
scram b
cd ../../
cmsDriver.py step1 --filein "file:Path_To_GENSIM_Output/EXO-RunIISummer15GS-01091.root" --fileout file:EXO-RunIISummer16DR80Premix-08160_step1.root  --pileup_input "file:pileupNew.root" --mc --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:@frozen2016 --nThreads 4 --datamix PreMix --era Run2_2016 --python_filename EXO-RunIISummer16DR80Premix-08160_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100 || exit $? ; 

cmsDriver.py step2 --filein file:EXO-RunIISummer16DR80Premix-08160_step1.root --fileout file:EXO-RunIISummer16DR80Premix-08160.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step RAW2DIGI,RECO,EI --nThreads 4 --era Run2_2016 --python_filename EXO-RunIISummer16DR80Premix-08160_2_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100 || exit $? ; 
